...
save(res.admin1,
     file = paste0(folder.name, '/',
                   country,
                   '_res_rw2main_randomSlopes_rw1xICAR_admin1posthocBench.rda'))
write.csv(res.admin1$overall, row.names = FALSE,
          file = paste0(folder.name, '/',
                        country,
                        '_res_rw2main_randomSlopes_rw1xICAR_admin1posthocBench.csv'))
save(res.admin2,
     file = paste0(folder.name, '/',
                   country,
                   '_res_rw2main_randomSlopes_rw1xICAR_admin2posthocBench.rda'))
write.csv(res.admin2$overall, row.names = FALSE,
          file =  paste0(folder.name, '/',
                         country,
                         '_res_rw2main_randomSlopes_rw1xICAR_admin2posthocBench.csv'))
