...
admin1.nb <- poly2nb(poly.adm1)
admin1.mat <- nb2mat(admin1.nb)
...
mod.dat <- mod.dat[mod.dat$v005 > 0.0001,]
rownames(admin1.mat) <- sort(unique(mod.dat$admin1.char))
  colnames(admin1.mat) <- sort(unique(mod.dat$admin1.char))
