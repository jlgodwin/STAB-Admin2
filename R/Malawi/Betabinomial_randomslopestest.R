...
fitBetabin <- function(country, type.st, beg.year,
  ...
  doAdmin1 = FALSE
  doNatl = FALSE
  randomSlopesRW1=TRUE
  randomSlopesAR1=TRUE
  no.strata=TRUE
  cluster=FALSE
  refit = TRUE
  refitBench = TRUE
  ...
  if(no.strata){
    ...
    if(doAdmin1){
      ...
      if (randomSlopesRW1) {
        ...
        if (doBenchmark) stop("Benchmarking not implemented for random slopes yet")
...
fitBetabin(country, type.st = 4, cluster = cluster,
           ...
           doRandomSlopesRW1=TRUE,
           doRandomSlopesAR1=TRUE,
           refitBench = FALSE, loadSamples = FALSE,
           doNatl = FALSE, doAdmin1= TRUE, doAdmin2 = FALSE,
