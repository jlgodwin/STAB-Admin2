...
igme.country="Democratic Republic of the Congo"
...
igme.ests <- igme.ests[igme.ests$REF_AREA == igme.country, ]
...
ihme.country="Democratic Republic of the Congo"
ihme.ests <- lapply(ihme.ests, function(x){
  if(!(ihme.country %in% x$ADM0_NAME)){
    message('\n Country name not found in one of the IHME files.\n')
  }
  x[x$ADM0_NAME == ihme.country,]
})
