...
testing <- FALSE
country_vt <- c("Senegal") 
# admin_vt <- c("admin1") ## admin level
# level_vt <- c(1) ## polygon level
admin_vt <- c("admin2") ## admin level
level_vt <- c(2) ## polygon level

#### If you are doing 
# timemod_vt <- c("rw2main_randomSlopes_rw1xICAR")
  ...
  for(admin in admin_vt){
    ...
    for(timemod in timemod_vt){
      for(strat in strat_vt){
        ...
        print(SUMMER::mapPlot(data = data_plot_dt, is.long = T,
                              variables = "Year",
       ...
       print(SUMMER::mapPlot(data = data_plot_dt, is.long = T,
        ...
        {
        print(SUMMER::mapPlot(data = data_plot_dt[data_plot_dt$Year == 2019,],
                              is.long = T, 
                              variables = "Year", 
                              values = "U5MR_median",direction = -1,
                              geo = map_shp, ncol = 5,
        ...
        pdf(paste0(folder.name, "/Plots/Betabinomial/map/",
            ...
            width = 3.5, height = 3.5)
        {
          print(SUMMER::mapPlot(data = data_plot_dt[data_plot_dt$Year == 2009,],
                                is.long = T, 
                                variables = "Year", 
                                values = "U5MR_median",direction = -1,
                                geo = map_shp, ncol = 5,
        ...
        pdf(paste0(folder.name, "/Plots/Betabinomial/map/",
            ...
            width = 3.5, height = 3.5)
        {
          print(SUMMER::mapPlot(data = data_plot_dt[data_plot_dt$Year == 1999,],
                                is.long = T, 
                                variables = "Year", 
                                values = "U5MR_median",direction = -1,
                                geo = map_shp, ncol = 5,
        ...
        pdf(paste0(folder.name, "/Plots/Betabinomial/map/",
            ...
            width = 3.5, height = 3.5)
        {
          print(SUMMER::mapPlot(data = data_plot_dt[data_plot_dt$Year == 1990,],
                                is.long = T, 
                                variables = "Year", 
                                values = "U5MR_median",direction = -1,
                                geo = map_shp, ncol = 5,
        ...
        pdf(paste0(folder.name, "/Plots/Betabinomial/map/",
            ...
            width = 7, height = 7)
        {
          print(SUMMER::mapPlot(data = data_plot_dt[data_plot_dt$Year %in% 
