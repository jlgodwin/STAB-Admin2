  ...
  if(no.strata){
    ...
    if(doNatl){
      ...
      if(doRW){
        ...
        res.natl <- getSmoothed(inla_mod = fit.natl, 
                                ...
                                include_time_unstruct = 2008)
        save(res.natl, file = paste0(folder.name, '/',
                                     country, '_res_rw2_natl_incl_2008_temp.rda'))
        ...
        if(doBenchmark & !useHIVAdj){
          ...
          res.natl <- getSmoothed(inla_mod = fit.natl, 
                                  ...
                                  include_time_unstruct = 2008)
          save(res.natl, file = paste0(folder.name, '/',
                                       country, '_res_rw2_natlBench_incl_2008_temp.rda'))
    ...
    if(doAdmin1){
      ...
      if(doRW){
        ...
        if(doBenchmark & !useHIVAdj){
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2_admin1Bench_noStrata_modelchecks.rda'))
          
          PosteriorInteractions <- fit.admin1$fit$summary.random$time.area
          save(PosteriorInteractions,
               file = paste0(folder.name, '/',
                             country,
                             '_rw2_admin1Bench_noStrata_PosteriorInteractions.rda'))
      ...
      if(doAR){
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_ar1_admin1_noStrata_modelchecks.rda'))
        
        PosteriorInteractions <- fit.admin1$fit$summary.random$region.int
        save(PosteriorInteractions,
             file = paste0(folder.name, '/',
                           country,
                           '_ar1_admin1_noStrata_PosteriorInteractions.rda'))
        ...
        if(doBenchmark & !useHIVAdj){
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_ar1_admin1Bench_noStrata_modelchecks.rda'))
          
          PosteriorInteractions <- fit.admin1$fit$summary.random$region.int
          save(PosteriorInteractions,
               file = paste0(folder.name, '/',
                             country,
                             '_ar1_admin1Bench_noStrata_PosteriorInteractions.rda'))
    ...
    if(doAdmin2){
      ...
      if(doRW){
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_rw2_admin2_noStrata_modelchecks.rda'))
        
        PosteriorInteractions <- fit.admin2$fit$summary.random$time.area
        save(PosteriorInteractions,
             file = paste0(folder.name, '/',
                           country,
                           '_rw2_admin2_noStrata_PosteriorInteractions.rda'))
        ...
        if(doBenchmark & !useHIVAdj){
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2_admin2Bench_noStrata_modelchecks.rda'))
          
          PosteriorInteractions <- fit.admin2$fit$summary.random$time.area
          save(PosteriorInteractions,
               file = paste0(folder.name, '/',
                             country,
                             '_rw2_admin2Bench_noStrata_PosteriorInteractions.rda'))
      ...
      if(doAR){
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_ar1_admin2_noStrata_modelchecks.rda'))
        
        PosteriorInteractions <- fit.admin2$fit$summary.random$region.int
        save(PosteriorInteractions,
             file = paste0(folder.name, '/',
                           country,
                           '_ar1_admin2_noStrata_PosteriorInteractions.rda'))
        ...
        if(doBenchmark & !useHIVAdj){
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_ar1_admin2Bench_noStrata_modelchecks.rda'))
          
          PosteriorInteractions <- fit.admin2$fit$summary.random$region.int
          save(PosteriorInteractions,
               file = paste0(folder.name, '/',
                             country,
                             '_ar1_admin2Bench_noStrata_PosteriorInteractions.rda'))
...
fitBetabin(country, type.st = 4, cluster = cluster,
           ...
           no.strata = TRUE,
           doAR = FALSE, doRW = T, 
           doRandomSlopesRW1 = FALSE,
           doRandomSlopesAR1 = TRUE,
           refit = TRUE,
           refitBench = TRUE, loadSamples = FALSE,
           doBenchmark = TRUE,
           doNatl = TRUE,
           doAdmin1= F, doAdmin2 = F,
