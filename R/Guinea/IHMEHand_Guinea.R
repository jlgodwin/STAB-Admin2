...
old <- c(3,4,5,6,7,8,9,11,14,15,16,22,23,29,30,31,32,33,34,35,36,37)
new <- c(3,5,6,7,8,8,9,11,14,16,15,23,22,29,30,29,30,33,31,32,33,34)

adm2.compare[,"GADM"] <- replace(
  adm2.compare[,"GADM"],
  old,
  adm2.compare[,"GADM"][new]
)
adm2.compare
