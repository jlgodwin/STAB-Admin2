...
fitBetabin <- function(country, type.st, beg.year,
  ...
  poly.file <- "/shapeFiles_gadm/npl"
  poly.layer.adm0 <- 'npl_admbnda_adm0_nd_20180806'
  poly.layer.adm1 <- 'npl_admbnda_adm1_nd_20180806'
  poly.layer.adm2 <- 'npl_admbnda_districts_nd_20180806'
  ...
  # set names for Nepal's 7 provinces (admin 1) in the adm1 shapefile
  poly.adm1$NAME_1 <- paste("Province", as.character(poly.adm1$ADM1_EN))
  poly.adm1$NAME_1[poly.adm1$NAME_1 == "Province 3"] <- "Bagmati"
  poly.adm1$NAME_1[poly.adm1$NAME_1 == "Province 4"] <- "Gandaki"
  poly.adm1$NAME_1[poly.adm1$NAME_1 == "Province 6"] <- "Karnali"
  poly.adm1$NAME_1[poly.adm1$NAME_1 == "Province 7"] <- "Sudurpashchim"
  
  # set names for Nepal's 7 provinces (admin 1) in the adm2 shapefile
  poly.adm2$NAME_1 <- paste("Province", as.character(poly.adm2$ADM1_EN))
  poly.adm2$NAME_1[poly.adm2$NAME_1 == "Province 3"] <- "Bagmati"
  poly.adm2$NAME_1[poly.adm2$NAME_1 == "Province 4"] <- "Gandaki"
  poly.adm2$NAME_1[poly.adm2$NAME_1 == "Province 6"] <- "Karnali"
  poly.adm2$NAME_1[poly.adm2$NAME_1 == "Province 7"] <- "Sudurpashchim"
  
  # set Nepal's districts as admin 2 names
  poly.adm2$NAME_2 <- poly.adm2$DIST_EN
    ...
    if(doAdmin1){
      ...
      if (doRandomSlopesRW1) {
        ...
        if(!file.exists(paste0(folder.name, '/',
          ...
          message(paste0("Starting no strata random slopes RW1xICAR admin 1 model for ", country, ".\n"))
          ...
          save(fit.admin1, file = paste0(folder.name, '/',
                                         country, '_rw2main_randomSlopes_rw1xICAR_admin1.rda'))
        }else{
          load(paste0(folder.name, '/', country,
                      '_rw2main_randomSlopes_rw1xICAR_admin1.rda'), envir = .GlobalEnv)
        }
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_rw2main_randomSlopes_rw1xICAR_admin1_noStrata_modelchecks.rda'))
        ...
        if(loadSamples & refit){
          ...
          load(paste0(folder.name, '/',
                      country, '_res_rw2main_randomSlopes_rw1xICAR_admin1.rda'), envir = .GlobalEnv)
        }else if(!loadSamples){
          ...
          save(res.admin1, file = paste0(folder.name, '/',
                                         country, '_res_rw2main_randomSlopes_rw1xICAR_admin1.rda'))
        }
        
        
        if(doBenchmark & !useHIVAdj){
          message(paste0("Starting no strata random slopes with RW1xICAR admin 1 benchmarking model for ",
                         country, ".\n"))
          
          if(refitBench){
            if(!refit){
              load(paste0(folder.name, '/',
                          country, '_rw2main_randomSlopes_rw1xICAR_admin1.rda'), envir = .GlobalEnv)
            }
            ...
            bench.adj$ratio <- bench.adj$est/bench.adj$igme
            save(bench.adj, file = paste0(folder.name, '/',
                                          country, '_rw2main_randomSlopes_rw1xICAR_admin1Benchmarks.rda'))
            ...
            fit.admin1 <- fitINLA2(data = mod.dat, family = "betabinomial",
                                   ...
                                   survey.effect = TRUE)
            save(fit.admin1, file = paste0(folder.name, '/',
                                           country, '_rw2main_randomSlopes_rw1xICAR_admin1Bench.rda'))
          }else{
            load(paste0(folder.name, '/',
                        country, '_rw2main_randomSlopes_rw1xICAR_admin1Bench.rda'), envir = .GlobalEnv)
          }
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2main_randomSlopes_rw1xICAR_admin1Bench_noStrata_modelchecks.rda'))
          ...
          if(loadSamples & refitBench){
            ...
            load(paste0(folder.name, '/',
                        country, '_res_rw2main_randomSlopes_rw1xICAR_admin1Bench.rda'), envir = .GlobalEnv)
          }else if(!loadSamples){
            res.admin1 <- getSmoothed(inla_mod = fit.admin1, Amat = admin1.mat,
                                      ...
                                      save.draws.est = TRUE)
            save(res.admin1, file = paste0(folder.name, '/',
                                           country, '_res_rw2main_randomSlopes_rw1xICAR_admin1Bench.rda'))
          }
          ...
          message(paste0("Starting no strata random slopes RW1xICAR admin 1 benchmarking model for ",
                         country, ".\n"))
          if(refitBench){
            if(!refit){
              load(paste0(folder.name, '/',
      ...
      if (doRandomSlopesAR1) {
        ...
        bench.adj$ratio <- 1.0
        if(!file.exists(paste0(folder.name, '/',
                               country, '_rw2main_randomSlopes_ar1xICAR_admin1.rda')) | refit){
          message(paste0("Starting no strata random slopes AR1xICAR admin 1 model for ", country, ".\n"))
          ...
          load(paste0(folder.name, '/', country,
                      '_rw2main_randomSlopes_ar1xICAR_admin1.rda'), envir = .GlobalEnv)
        }
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_rw2main_randomSlopes_ar1xICAR_admin1_noStrata_modelchecks.rda'))
        ...
        if(loadSamples & refit){
          ...
          load(paste0(folder.name, '/',
                      country, '_res_rw2main_randomSlopes_ar1xICAR_admin1.rda'), envir = .GlobalEnv)
        }else if(!loadSamples){
          res.admin1 <- getSmoothed(inla_mod = fit.admin1,
                                    year_range = beg.year:end.year,
                                    year_label = beg.year:end.year, 
        ...
        if(doBenchmark & !useHIVAdj){
          message(paste0("Starting no strata random slopes with AR1xICAR admin 1 benchmarking model for ",
                         country, ".\n"))
          ...
          if(refitBench){
            ...
            bench.adj$ratio <- bench.adj$est/bench.adj$igme
            save(bench.adj, file = paste0(folder.name, '/',
                                          country, '_rw2main_randomSlopes_ar1xICAR_admin1Benchmarks.rda'))
            ...
            fit.admin1 <- fitINLA2(data = mod.dat, family = "betabinomial",
                                   ...
                                   survey.effect = TRUE)
            save(fit.admin1, file = paste0(folder.name, '/',
                                           country, '_rw2main_randomSlopes_ar1xICAR_admin1Bench.rda'))
          }else{
            load(paste0(folder.name, '/',
                        country, '_rw2main_randomSlopes_ar1xICAR_admin1Bench.rda'), envir = .GlobalEnv)
          }
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2main_randomSlopes_ar1xICAR_admin1Bench_noStrata_modelchecks.rda'))
          ...
          if(loadSamples & refitBench){
            ...
            load(paste0(folder.name, '/',
                        country, '_res_rw2main_randomSlopes_ar1xICAR_admin1Bench.rda'), envir = .GlobalEnv)
          }else if(!loadSamples){
            res.admin1 <- getSmoothed(inla_mod = fit.admin1, Amat = admin1.mat,
                                      year_range = beg.year:end.year, 
                                      year_label = beg.year:end.year, 
                                      ...
                                      draws = NULL, save.draws = TRUE)
            save(res.admin1, file = paste0(folder.name, '/',
                                           country, '_res_rw2main_randomSlopes_ar1xICAR_admin1Bench.rda'))
          }
    ...
    if(doAdmin2){
      ...
      if (doRandomSlopesRW1) {
        ...
        if(!file.exists(paste0(folder.name, '/',
          ...
          message(paste0("Starting no strata random slopes RW1xICAR admin 2 model for ", country, ".\n"))
          ...
          save(fit.admin2, file = paste0(folder.name, '/',
                                         country, '_rw2main_randomSlopes_rw1xICAR_admin2.rda'))
        }else{
          load(paste0(folder.name, '/', country,
                      '_rw2main_randomSlopes_rw1xICAR_admin2.rda'), envir = .GlobalEnv)
        }
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_rw2main_randomSlopes_rw1xICAR_admin2_noStrata_modelchecks.rda'))
        ...
        if(loadSamples & refit){
          ...
          load(paste0(folder.name, '/',
                      country, '_res_rw2main_randomSlopes_rw1xICAR_admin2.rda'), envir = .GlobalEnv)
        }else if(!loadSamples){
          ...
          save(res.admin2, file = paste0(folder.name, '/',
                                         country, '_res_rw2main_randomSlopes_rw1xICAR_admin2.rda'))
        }
        
        
        if(doBenchmark & !useHIVAdj){
          message(paste0("Starting no strata random slopes with RW1xICAR admin 2 benchmarking model for ",
                         country, ".\n"))
          
          if(refitBench){
            if(!refit){
              load(paste0(folder.name, '/',
                          country, '_rw2main_randomSlopes_rw1xICAR_admin2.rda'), envir = .GlobalEnv)
            }
            ...
            bench.adj$ratio <- bench.adj$est/bench.adj$igme
            save(bench.adj, file = paste0(folder.name, '/',
                                          country, '_rw2main_randomSlopes_rw1xICAR_admin2Benchmarks.rda'))
            ...
            fit.admin2 <- fitINLA2(data = mod.dat, family = "betabinomial",
                                   ...
                                   survey.effect = TRUE)
            save(fit.admin2, file = paste0(folder.name, '/',
                                           country, '_rw2main_randomSlopes_rw1xICAR_admin2Bench.rda'))
          }else{
            load(paste0(folder.name, '/',
                        country, '_rw2main_randomSlopes_rw1xICAR_admin2Bench.rda'), envir = .GlobalEnv)
          }
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2main_randomSlopes_rw1xICAR_admin2Bench_noStrata_modelchecks.rda'))
          ...
          if(loadSamples & refitBench){
            ...
            load(paste0(folder.name, '/',
                        country, '_res_rw2main_randomSlopes_rw1xICAR_admin2Bench.rda'), envir = .GlobalEnv)
          }else if(!loadSamples){
            res.admin2 <- getSmoothed(inla_mod = fit.admin2, Amat = admin2.mat,
                                      year_range = beg.year:end.year, 
                                      year_label = beg.year:end.year, 
                                      nsim = 1000, 
                                      weight.strata = NULL,
                                      ...
                                      save.draws.est = TRUE)
            save(res.admin2, file = paste0(folder.name, '/',
                                           country, '_res_rw2main_randomSlopes_rw1xICAR_admin2Bench.rda'))
          }
          ...
          message(paste0("Starting no strata random slopes RW1xICAR admin 2 benchmarking model for ",
                         country, ".\n"))
          if(refitBench){
            if(!refit){
              load(paste0(folder.name, '/',
      ...
      if (doRandomSlopesAR1) {
        ...
        bench.adj$ratio <- 1.0
        if(!file.exists(paste0(folder.name, '/',
                               country, '_rw2main_randomSlopes_ar1xICAR_admin2.rda')) | refit){
          message(paste0("Starting no strata random slopes AR1xICAR admin 2 model for ", country, ".\n"))
          ...
          load(paste0(folder.name, '/', country,
                      '_rw2main_randomSlopes_ar1xICAR_admin2.rda'), envir = .GlobalEnv)
        }
        ...
        #      file = paste0(folder.name, '/',
        #                    country,
        #                    '_rw2main_randomSlopes_ar1xICAR_admin2_noStrata_modelchecks.rda'))
        ...
        if(loadSamples & refit){
          ...
          load(paste0(folder.name, '/',
                      country, '_res_rw2main_randomSlopes_ar1xICAR_admin2.rda'), envir = .GlobalEnv)
        }else if(!loadSamples){
          res.admin2 <- getSmoothed(inla_mod = fit.admin2,
                                    year_range = beg.year:end.year,
                                    year_label = beg.year:end.year, 
        ...
        if(doBenchmark & !useHIVAdj){
          message(paste0("Starting no strata random slopes with AR1xICAR admin 2 benchmarking model for ",
                         country, ".\n"))
          ...
          if(refitBench){
            ...
            bench.adj$ratio <- bench.adj$est/bench.adj$igme
            save(bench.adj, file = paste0(folder.name, '/',
                                          country, '_rw2main_randomSlopes_ar1xICAR_admin2Benchmarks.rda'))
            ...
            fit.admin2 <- fitINLA2(data = mod.dat, family = "betabinomial",
                                   ...
                                   survey.effect = TRUE)
            save(fit.admin2, file = paste0(folder.name, '/',
                                           country, '_rw2main_randomSlopes_ar1xICAR_admin2Bench.rda'))
          }else{
            load(paste0(folder.name, '/',
                        country, '_rw2main_randomSlopes_ar1xICAR_admin2Bench.rda'), envir = .GlobalEnv)
          }
          ...
          #      file = paste0(folder.name, '/',
          #                    country,
          #                    '_rw2main_randomSlopes_ar1xICAR_admin2Bench_noStrata_modelchecks.rda'))
          ...
          if(loadSamples & refitBench){
            ...
            load(paste0(folder.name, '/',
                        country, '_res_rw2main_randomSlopes_ar1xICAR_admin2Bench.rda'), envir = .GlobalEnv)
          }else if(!loadSamples){
            res.admin2 <- getSmoothed(inla_mod = fit.admin2, Amat = admin2.mat,
                                      year_range = beg.year:end.year, 
                                      year_label = beg.year:end.year, 
                                      ...
                                      save.draws.est = TRUE)
            save(res.admin2, file = paste0(folder.name, '/',
                                           country, '_res_rw2main_randomSlopes_ar1xICAR_admin2Bench.rda'))
          }
          ...
          message(paste0("Starting no strata random slopes AR1xICAR admin 2 benchmarking model for ",
                         country, ".\n"))
          if(refitBench){
            if(!refit){
              load(paste0(folder.name, '/',
...
library(scales)
library(INLA)
# NB: the following line is used to make 
#     INLA compatible with Linux servers
#     when you get a GLIB_C error
...
igme.dir.rel <- '..'
ihme.dir.rel <- '..'
shapes.sub.dir <- '/shapeFiles_gadm/npl'
hiv.dir.rel <- '..'
...
## NB: Download sheets from the command center
##     as .csv to use on servers in batch mode
##     may need to edit a few lines within function too
# CountryList <- sheets_read(sheet_key, sheet = "CountryList")
CountryList <- read.csv("CountryList.csv", header = T)
