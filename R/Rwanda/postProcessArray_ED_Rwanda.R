...
load(paste0(folder.name,'/', country, '_res_rw2_natlEDCI90.rda'))
...
load(paste0(folder.name,'/', country, '_res_rw2_natlEDBenchCI90.rda'))
load(paste0(folder.name, '/', country, '_rw2',
            '_natlEDBenchmarks.rda'))
...
load(paste0(folder.name,'/', country,
            '_res_', time.mod, '_admin1EDCI90.rda'))
write.csv(res.admin1$overall,
          file = paste0(folder.name, '/',
                        country, '_res_', time.mod, '_admin1EDCI90.csv'),
          row.names = FALSE)
...
load(paste0(folder.name,'/', country,
            '_res_', time.mod, '_admin1EDBenchCI90.rda'))
write.csv(res.admin1$overall,
          file = paste0(folder.name, '/',
                        country, '_res_', time.mod, '_admin1EDBenchCI90.csv'),
          row.names = FALSE)
load(paste0(folder.name,'/', country, '_', 
            time.mod, '_admin1EDBenchmarks.rda'))
load(paste0(folder.name, '/', country, 
...
load(paste0(folder.name,'/', country,
            '_res_', time.mod, '_admin2EDCI90.rda'))
write.csv(res.admin2$overall,
          file = paste0(folder.name, '/',
                        country, '_res_', time.mod, '_admin2EDCI90.csv'),
          row.names = FALSE)
load(paste0(folder.name,'/', country, '_', 
...
load(paste0(folder.name,'/', country,
            '_res_', time.mod, '_admin2EDBenchCI90.rda'))
write.csv(res.admin2$overall,
          file = paste0(folder.name, '/',
                        country, '_res_', time.mod,'_admin2EDBenchCI90.csv'),
          row.names = FALSE)
load(paste0(folder.name,'/', country, '_', 
            time.mod, '_admin2EDBenchmarks.rda'))
load(paste0(folder.name, '/', country, 
