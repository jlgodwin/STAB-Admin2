...
message("Assigned to Admin 1: ",unique(mod.dat$admin1.name[mod.dat$survey == 2011 &
                             mod.dat$cluster == clus]),"\n")
message("Assigned to Admin 2:: ",unique(mod.dat$admin2.name[mod.dat$survey == 2011 &
                                                  mod.dat$cluster == clus]))
...
mod.dat$admin1.char[mod.dat$cluster == clus.no] <- "admin1_6"
mod.dat$admin1.name[mod.dat$cluster == clus.no] <- "Maputo City"
mod.dat$admin2.char[mod.dat$cluster == clus.no] <- "admin2_56"
mod.dat$admin2.name[mod.dat$cluster == clus.no] <- "Maputo"


head(mod.dat[mod.dat$cluster == clus.no,])
