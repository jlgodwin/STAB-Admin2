...
#### Looking at duplicates in GADM ####

sort(as.character(admin2.names$GADM))

summary(poly.adm2@data) # NAME_2
idx <- which(poly.adm2@data$NAME_2 == "North Shewa")
...
legend("topright","North Shewa",col="#FF0000",pch=15)
dev.off()

#### compare to IHME ####

ihme2 <- ihme.ests$adm2
ihme2[which(ihme2$ADM2_NAME=="North Shewa"),]
